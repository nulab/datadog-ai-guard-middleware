...
function convertMessage(message: LanguageModelV2Message): AIGuardMessage | AIGuardMessage[] {
  switch (message.role) {
    case "system":
      return {
        role: message.role,
...
export function convertToAIGuardFormat(prompt: LanguageModelV2Message[]): AIGuardMessage[] {
