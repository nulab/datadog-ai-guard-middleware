...
Datadog AI Guard middleware for [Vercel AI SDK](https://sdk.vercel.ai/) v5 (`@ai-sdk/provider@^2`).

> Using AI SDK v6? See [`@nulab/datadog-ai-guard-middleware-ai-v3`](https://www.npmjs.com/package/@nulab/datadog-ai-guard-middleware-ai-v3) instead.

## Installation

```bash
npm install @nulab/datadog-ai-guard-middleware-ai-v2
```
...
} from "@nulab/datadog-ai-guard-middleware-ai-v2";
